...
PROGNAME = LunarInvader

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o BG.o GameScreen.o Ship.o BlueBullet2.o MainTitle.o MinorEnemy.o life1.o life2.o life3.o WinScreen.o myLib.o text.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = BG.h GameScreen.h ship.h BlueBullet2.h MainTitle.h MinorEnemy.h life1.h life2.h life3.h WinScreen.h myLib.h text.h font.h
